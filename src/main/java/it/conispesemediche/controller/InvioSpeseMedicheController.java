...
//import it.conispesemediche.beanfromxsd.generated.Precompilata;
...
public class InvioSpeseMedicheController {
	
	private static final Logger logger = Logger.getLogger(InvioSpeseMedicheController.class);
	...
	@Value("${sportsalute.xml.path}")
	private String fileDaCriptare;

	@Value("${sportsalute.xml.path.cript}")
    ...
    public String doLogin(final Model model, final HttpServletRequest request, final HttpServletResponse response) {
    	...
    	logger.info("*** Fine Invio Spese Mediche ***");
